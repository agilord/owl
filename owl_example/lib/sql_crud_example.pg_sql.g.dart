...
@Deprecated('Use getSqlCrudExampleDdl() instead.')
...
List<String> getSqlCrudExampleDdl({String schema}) {
  ...
  return <String>[
    ...
    """ALTER TABLE ${schemaPrefix}my_custom_entity ADD COLUMN IF NOT EXISTS entity_id INTEGER ;""",
    ...
    """ALTER TABLE ${schemaPrefix}entity_detail ADD COLUMN IF NOT EXISTS entity_id INTEGER ;""",
    """ALTER TABLE ${schemaPrefix}entity_detail ADD COLUMN IF NOT EXISTS detail_id INTEGER ;""",
